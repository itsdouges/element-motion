...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.withTransition = exports.TransitionContainer = undefined;

	var _TransitionContainer = __webpack_require__(1);

	Object.defineProperty(exports, 'TransitionContainer', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_TransitionContainer).default;
	  }
	});

	var _withTransition = __webpack_require__(40);

	Object.defineProperty(exports, 'withTransition', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_withTransition).default;
	  }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _yubabaCore = __webpack_require__(38);
	...
	var TransitionContainer = function (_React$Component) {
	  ...
	  function TransitionContainer() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TransitionContainer.__proto__ || Object.getPrototypeOf(TransitionContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      visible: false
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				Object.defineProperty(exports, 'addTransitionListener', {
					enumerable: true,
					get: function get() {
						return _orchestrator.addTransitionListener;
					}
				});
				...
				Object.defineProperty(exports, 'expand', {
					enumerable: true,
					get: function get() {
						return _transitions.expand;
					}
				});
				Object.defineProperty(exports, 'fadeout', {
					enumerable: true,
					get: function get() {
						return _transitions.fadeout;
					}
				});
				Object.defineProperty(exports, 'move', {
					enumerable: true,
					get: function get() {
						return _transitions.move;
					}
				});
				Object.defineProperty(exports, 'reveal', {
					enumerable: true,
					get: function get() {
						return _transitions.reveal;
					}
				});
			...
			/***/function (module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */(function (process) {
					...
					var yubabaTransitions = _interopRequireWildcard(_transitions);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				var _transitioner = __webpack_require__(4);

				var _transitioner2 = _interopRequireDefault(_transitioner);

				var _deferred = __webpack_require__(7);
			...
			/***/function (module, exports, __webpack_require__) {
				...
				function setTarget(element, _ref, fromElement) {
					var newElement = _ref.newElement,
					    cloneElement = _ref.cloneElement,
					    _ref$createInBody = _ref.createInBody,
				...
				function setEvents(element, _ref2) {
					var onStart = _ref2.onStart,
					    resolve = _ref2.resolve,
					    autoCleanup = _ref2.autoCleanup,
					    name = _ref2.name,
					    resetHeightOnFinish = _ref2.resetHeightOnFinish;
					...
					var transitionCleaned = false;

					var cleanup = function cleanup() {
						if (transitionCleaned) {
							return;
						}
				...
				function setInitialStyles(element, _ref3) {
					var from = _ref3.from,
					    immediatelyApplyFrom = _ref3.immediatelyApplyFrom,
					    styleApply = _ref3.styleApply,
					    duration = _ref3.duration,
					    transitions = _ref3.transitions;

					element.style.transition = transitions.map(function (transition) {
				...
				function transitionFactory(element, _ref4) {
					var applyTranslateTransform = _ref4.applyTranslateTransform,
					    applyScaleTransform = _ref4.applyScaleTransform,
					    applyStyle = _ref4.applyStyle,
					    delay = _ref4.delay,
					    from = _ref4.from;
						...
						setTimeout(function () {
							requestAnimationFrame(function () {
								if (applyTranslateTransform) {
									(0, _dom.transformTranslate)(element, {
										x: to.left - from.left,
										y: to.top - from.top
									});
								}
								...
								if (applyScaleTransform) {
									(0, _dom.transformScale)(element, to);
								}
				...
				function transitioner(element, _ref5) {
					var _ref5$transition = _ref5.transition,
					    name = _ref5$transition.name,
					    from = _ref5$transition.from,
					    options = _ref5$transition.options,
					    _ref5$options = _ref5.options,
					    onStart = _ref5$options.onStart,
					    _ref5$options$delay = _ref5$options.delay,
					    delay = _ref5$options$delay === undefined ? 5 : _ref5$options$delay,
					    _ref5$options$duratio = _ref5$options.duration,
					    duration = _ref5$options$duratio === undefined ? 0.5 : _ref5$options$duratio,
					    autoCleanup = _ref5$options.autoCleanup,
					    resolve = _ref5.resolve;

					var target = setTarget(element, options, from);
...
;
//# sourceMappingURL=yubaba-react.js.map
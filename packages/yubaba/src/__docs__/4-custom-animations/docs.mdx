...
<Styled.Container>
  <Toggler interval>
    {toggler => (
      <Animator key={toggler.shown} name="element-animation-1">
        <OneFullRotation>
          {({ ref, ...props }) => (
            <Styled.InlineBlock
...
<Styled.Container>
  <Toggler interval>
    {toggler => (
      <Animator key={toggler.shown} name="element-animation-2">
        <Move>
          <OneFullRotation>
            {({ ref, ...props }) => (
              <Styled.InlineBlock
...
<Styled.Container>
  <Toggler>
    {toggler => (
      <Animator key={toggler.shown} name="supporting-animation-1">
        <SupportingAnimation>
          {({ ref, ...props }) => (
            <Styled.InlineBlock
              alignSelf="flex-start"

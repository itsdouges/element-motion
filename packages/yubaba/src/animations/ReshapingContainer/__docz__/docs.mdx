...
<Playground>
  <Common.Toggler interval onIntervalSet={val => `${(val + 1) % 3}`}>
    {toggler => (
      <Styled.Container>
        <Styled.Background />
        ...
        <Styled.Header>
          ...
          <Styled.MenuLink
            href="#"
            onMouseEnter={() => toggler.set('1')}
            onFocus={() => toggler.set('1')}
            onMouseLeave={() => toggler.set()}
            onBlur={() => toggler.set()}
          >
            Products
          </Styled.MenuLink>
          <Styled.MenuLink
            href="#"
            onMouseEnter={() => toggler.set('2')}
            onFocus={() => toggler.set('2')}
            onMouseLeave={() => toggler.set()}
            onBlur={() => toggler.set()}
          >
            Developers
          ...
          <Styled.MenuLink
            href="#"
            onMouseEnter={() => toggler.set('3')}
            onFocus={() => toggler.set('3')}
            onMouseLeave={() => toggler.set()}
            onBlur={() => toggler.set()}
          >
            Company
